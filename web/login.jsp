...
<TABLE width="100%" height="100%" cellSpacing="1" cellPadding="1" border="0"style="z-index:100;position:absolute;">
		...
		<TR>
		 <TD valign="center">
			...
			<TR valign="bottom" height="1">
				<TD width="560" class="login" align="right">帐&nbsp;&nbsp;号：  </TD>
				<TD>
		    ...
		    <TR valign="top" height="280">		    
				...
				<TD class="login" align="center">
					<input type="submit" value="登&nbsp;录" class="btn_login" onmousedown="javascript:btn_login_down(this);" onmouseover="javascript:btn_login_over(this);" onmouseout="javascript:btn_login_out(this);"/>
				</TD>	
	...
	<TR>
		<TD width="100%" height="50px" valign="middle" style="background:url(./images/green/frame/login_copyright.png) repeat-x;">
			<div align="center" style="font-size: 15px;">许继集团研发中心 2016 &copy; 版权所有</div>
		</TD>
	</TR>
	</html:form>
</TABLE>

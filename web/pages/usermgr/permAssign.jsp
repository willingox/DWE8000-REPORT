...
%>
	...
	function setSelect(aobj, col) {
		...
		if(aobj.state == 0) {	// 未选状态
			...
			switch(col) {
				case 1:
					$('#rspan').html('读(全&emsp;选)');
					$('#ralink').attr('state', 0);
					$('#wspan').html('写(全&emsp;选)');
					$('#walink').attr('state', 0);
					$('#espan').html('执行(全&emsp;选)');
					$('#ealink').attr('state', 0);
					break;
				case 2:
					$('#wspan').html('写(全&emsp;选)');
...
<input type="hidden" name="roleId" value="${roleId}"/>			
	...
	<TR>
		<TD valign="top"height="35">	
			<a class="abtnLT" id="ralink" href="javascript:void(0)" onclick="javascript:setSelect(this, 1)" state="0"><span id="rspan">读(全&emsp;选)</span><a/>					
			<a class="abtnLT" id="walink" href="javascript:void(0)" onclick="javascript:setSelect(this, 2)" state="0"><span id="wspan">写(全&emsp;选)</span><a/>
			<a class="abtnLT" id="ealink" href="javascript:void(0)" onclick="javascript:setSelect(this, 3)" state="0"><span id="espan">执行(全&emsp;选)</span><a/>
			<a class="abtn3" href="javascript:doSubmit()"><span>保&nbsp;&nbsp;存</span></a>
		</TD>
	</TR>
</TABLE>
</BODY>

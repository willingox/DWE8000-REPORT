			...
			<TABLE width="100%" border="0" cellSpacing="0" cellPadding="1">
				<TR>
					<TD  align=left width="100%" style="padding-left:40">										
						负荷设置时间&nbsp&nbsp<input type="text" id="loadSetDate" name="loadSetDate" size="16"  onclick="WdatePicker({isShowWeek:true,isShowClear:false,readOnly:true,firstDayOfWeek:1,onpicking:pickingFunc})" id="fromDateId" class="dateInput" style=" background-color: #FFFFFF" title="点击选择负荷日期">
					</TD>

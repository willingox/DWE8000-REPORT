 ...
 <style type="text/css">
	...
	<script type="text/javascript">
		...
		if (msg.length > 0) {
		 ...
		 windGenwhDetailedDataForm.method.value = 'show';
...
<TABLE class="tabOutside" id="tabOutside">
	...
	<tr>
		 ...
		 <H4 style="color: #000000;"align="center">全场平均风速:${allAvgWindVelval}m/s&nbsp;&nbsp;&nbsp;全场最大风速:${maxWind}m/s(${maxTime})&nbsp;&nbsp;&nbsp;全场最小风速:${minWind}m/s(${minTime})</H4>
	 		</td> 
            </tr>	
	<!----------------------------------------简单条件-------------------------------------------------------------->
	<!--如有页面需要-->
			...
			<tr>
			  ...
			  <tr>			     
				...
				<ec:table 
					...
					items="resultTable"
					var="bean"
					action="${pageContext.request.contextPath}/datastatistics/windGenwhDetailedData.do?method=show"
					retrieveRowsCallback="process"
					sortRowsCallback="process"
					filterRowsCallback="process"
					xlsFileName="WindGenwhDetailedData.xls"
                              showTitle="ture"
					listWidth ="100%"
					listHeight="100%"
					width="100%"
					...
					<ec:row highlightRow="true">
					  ...
					  <ec:column   property="curp" title="功率(KW)" cell="number" format="0.000" headerClass="ecTableHead" styleClass="ecTableBody"  width="120" style="text-align:center"/>
					  <ec:column   property="windSpeed" title="风速" cell="number" format="0.000" headerClass="ecTableHead" styleClass="ecTableBody"  width="120" style="text-align:center"/>

...
function query1() {
		...
		if (document.generatorStatisticsMonReportDataForm.dateDisp.value == '') 
			msg.push('日期');
		if (msg.length > 0) {
			alert('请选择 ' + msg.join('，') + '!');
			return;
		}
		generatorStatisticsMonReportDataForm.method.value = 'show';
		generatorStatisticsMonReportDataForm.submit();
...
<BODY>
	...
	<TABLE style="border: 0; border-collapse: collapse; width:5500; " id="tabOutside">
		<!--如果有错误-->
		<TR height="1">
			<TD height="1">
				<div id="message">
		...
		<!----------------------------------------简单条件-------------------------------------------------------------->
		<html:form action="generatorStatisticsMonReportData" method="post">
			...
			<td id="chartTD" width="100%" height="100%" valign="top">
				...
				<table width="100%" height="100%" border="0" cellspacing="0"
					...
					<tr>
						...
						<td valign="top" align="left" width="500" height="100%"><ec:table
								items="result" var="bean"
								action="${pageContext.request.contextPath}/datastatistics/generatorStatisticsMonReportData.do?method=show"
								retrieveRowsCallback="process" sortRowsCallback="process"
								filterRowsCallback="process" xlsFileName="generatorStatisticsMonReportData.xls"
								showTitle="ture" listWidth="100%" listHeight="100%" width="5900"
								...
								<ec:row highlightRow="true">
									...
									<ec:column property="monthgenwh" title="发电量" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									...
									<ec:column property="avg_Temp" title="平均环境温度" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />	
									<ec:column property="monAvlbltRat" title="月可利用率(%)" cell="number"
										format="0.000" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monAvlbltHour" title="月可利用小时" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monNormTim" title="月运行小时" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monRunTim" title="月发电小时数" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monStopTim" title="月停机小时数" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monErrEmeTim" title="月故障小时数" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monSerTim" title="月维护小时数" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monGridErrTim" title="电网月故障时间" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
					...
					<tr>
						...
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计发电量： ${allMonthgenwh}</td>
						...
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月可利用率： ${allMonAvlbltRat}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月可利用小时： ${allMonAvlbltHour}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月运行小时： ${allMonNormTim}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月发电小时数： ${allMonRunTim}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月停机小时数： ${allMonStopTim}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月故障小时数： ${allMonErrEmeTim}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计月维护小时数： ${allMonSerTim}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计电网月故障时间： ${allMonGridErrTim}</td>

...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/popWaiting/popWaiting.js"></script>
 ...
 <style type="text/css">
	...
	<script type="text/javascript">
	 ...
	 function showTree() {
			...
			if (parent) {
				...
				var treeType="windPlcReportData"; //树类型
				var treeDepth="2"; //树深度
		...
		var msg = [];
		if (document.windPlcReportDataForm.startDateDisp.value == '') 
			msg.push('起始日期');
		
		if (document.windPlcReportDataForm.endDateDisp.value == '') 
			msg.push('终止日期');
		if(document.windPlcReportDataForm.endDateDisp.value < document.windPlcReportDataForm.startDateDisp.value)
			msg.push('正确时间');	
		  ...
		  windPlcReportDataForm.str.value = data;
		...
		windPlcReportDataForm.method.value = 'show';
		windPlcReportDataForm.submit();
  ...
  <body>
       <html:form action="windPlcReportData" method="post">
			...
			<tr>
			  ...
			  <tr>			     
				...
				<ec:table 
					...
					items="result"
					var="bean"
					action="${pageContext.request.contextPath}/datastatistics/windPlcReportData.do?method=show"
					retrieveRowsCallback="process"
					sortRowsCallback="process"
					filterRowsCallback="process"
					xlsFileName="windPlcReportData.xls"
                              showTitle="ture"
					listWidth ="100%"
					listHeight="100%"
					width="100%"
					...
					<ec:column   property="plcState" title="风机(plc)状态" headerClass="ecTableHead" styleClass="ecTableBody"  width="200" style="text-align:center"/>
					<ec:column   property="curTime" title="开始时间" cell="date" format="yyyy-MM-dd HH:mm:ss" headerClass="ecTableHead" styleClass="ecTableBody"  width="200" style="text-align:center"/>
					<ec:column   property="endTime" title="结束时间" cell="date" format="yyyy-MM-dd HH:mm:ss" headerClass="ecTableHead" styleClass="ecTableBody"  width="200" style="text-align:center"/>
					<ec:column  property="faultTime" title="持续时间(h)" cell="number" format="0.00" headerClass="ecTableHead" styleClass="ecTableBody"  width="120" style="text-align:center"/>

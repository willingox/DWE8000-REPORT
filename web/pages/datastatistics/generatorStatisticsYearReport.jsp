...
function query1() {
		...
		if (document.generatorStatisticsYearReportDataForm.dateDisp.value == '') 
			msg.push('日期');
		if (msg.length > 0) {
			alert('请选择 ' + msg.join('，') + '!');
			return;
		}
		generatorStatisticsYearReportDataForm.method.value = 'show';
		generatorStatisticsYearReportDataForm.submit();
...
<BODY>
	...
	<TABLE style="border: 0; border-collapse: collapse; width:3000; " id="tabOutside">
		...
		<!----------------------------------------简单条件-------------------------------------------------------------->
		<html:form action="generatorStatisticsYearReportData" method="post">
				...
				<table width="100%" height="100%" border="0" cellspacing="0"
					...
					<tr>
						...
						<td valign="top" align="left" width="100%" height="100%"><ec:table
								...
								action="${pageContext.request.contextPath}/datastatistics/generatorStatisticsYearReportData.do?method=show"
								retrieveRowsCallback="process" sortRowsCallback="process"
								filterRowsCallback="process" xlsFileName="generatorStatisticsuYearReportData.xls"
								showTitle="ture" listWidth="100%" listHeight="100%" width="4550"
								...
								<ec:row highlightRow="true">
									...
									<ec:column property="yeargenwh" title="发电量" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
										
									<ec:column property="yeaAvlbltRat" title="可利用率" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
									<ec:column property="monAvlbltHour" title="利用小时数" cell="number"
										format="0.00" headerClass="ecTableHead"
										styleClass="ecTableBody" width="150" style="text-align:center" />
					...
					<tr>
						...
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计发电量： ${allYeargenwh}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计年可利用率： ${allYeaAvlbltRat}</td>
						<td class="ecTableBody" style="width:150px;text-align:center;color:#339900;font-weight:bold">合计利用小时数： ${allMonAvlbltHour}</td>

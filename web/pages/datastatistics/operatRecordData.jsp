	...
	.menu_top_sys a:hover{
	 ...
	 function showTree() {
			...
			if (parent) {
				...
				var treeType="operatRecordData"; //树类型
				var treeDepth="2"; //树深度
  	...
  	function query() {
		...
		if (msg.length > 0) {
		 ...
		 var data = parent.getEuTreeSelected();
    		  ...
    		  operatRecordDataForm.equipId.value = data.substring(data.lastIndexOf("-")+1,data.length);
           
		  if(operatRecordDataForm.equipId.value<=0)
		  {
		  alert('请选择风机!');
			return;
		  }
			...
			<tr>
			  ...
			  <tr>			     
				...
				<ec:table 
					...
					<ec:column  property="description" title="动作状态"  headerClass="ecTableHead" styleClass="ecTableBody"  width="200" style="text-align:center"/>

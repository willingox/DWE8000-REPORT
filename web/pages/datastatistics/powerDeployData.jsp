				 ...
				 <TD width="10"></TD>
					...
					<TD  >									
						<div width="100%" height="15">
						 out.print(" <input id = 'alarmType1'  type='radio' name='alarmType' value='1' "checkd" />故障;
                                       out.print(" <input id = 'alarmType2'  type='radio' name='alarmType' value="+2+" "+request.getAttribute("check1")+" />"+"告警"); 

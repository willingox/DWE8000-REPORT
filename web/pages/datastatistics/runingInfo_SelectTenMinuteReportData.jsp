...
<script type="text/javascript">
 ...
 if (window.showModalDialog!=null)//IE判断
           {
      window.dialogArguments.runingInfo_TenMinuteReportDataForm.action = '${pageContext.request.contextPath}/datastatistics/runingInfo_TenMinuteReportData.do?check_val='+check_val;
		
		window.dialogArguments.runingInfo_TenMinuteReportDataForm.submit();
		window.close();
          }
      
          else{
          window.opener.runingInfo_TenMinuteReportDataForm.action = '${pageContext.request.contextPath}/datastatistics/runingInfo_TenMinuteReportData.do?check_val='+check_val;
		
		window.opener.runingInfo_TenMinuteReportDataForm.submit();
		top.close();

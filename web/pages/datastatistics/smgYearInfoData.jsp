 ...
 <style type="text/css">
	...
	<script type="text/javascript">
		function query() {
		 	 ...
		 	 smgYearInfoDataForm.method.value = 'show';
             smgYearInfoDataForm.submit();
...
<BODY>
<!--如有页面需要-->
	<html:form action="smgYearInfoData" method="post">
...
<TABLE class="tabOutside" id="tabOutside">
		...
		<TD style="width: 100%; text-align: left">
			<TABLE>	
    			<tr><td height="10px"></td></tr>	
					...
					<TD id="Select" >										
						<html:text  property="startDateDisp" styleId="startDateId" styleClass="dateInput" size="16" onclick="WdatePicker({dateFmt: 'yyyy', isShowToday: false, isShowClear: false, maxDate:'2022'})" title="点击选择起始日期" />
					</TD>				
				    <TD width="30"></TD>
	...
	<iframe id="reportFramed0"  src="/WebReport/ReportServer?reportlet=/year_1.cpt&date=${smgYearInfoDataForm.startDateDisp}-01-01">

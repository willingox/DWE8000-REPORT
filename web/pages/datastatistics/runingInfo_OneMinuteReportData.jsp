 ...
 <style type="text/css">
	...
	<script type="text/javascript">
	 ...
	 function showTree() {
			...
			if (parent) {
				...
				var treeType="runingInfo_OneMinuteReportData"; //树类型
				var treeDepth="2"; //树深度
		...
		alert(flagVal);
		runingInfo_OneMinuteReportDataForm.flag.value = flagVal;
		var msg = [];
	...
	var  flagVal = $("input[name='flag']:checked").val();
		...
		if(document.runingInfo_OneMinuteReportDataForm.endDateDisp.value < document.runingInfo_OneMinuteReportDataForm.startDateDisp.value)
		 ...
		 if(runingInfo_OneMinuteReportDataForm.flag.value=='')
		  {
	  ...
	  if (window.showModalDialog!=null)//IE判断
           {
          window.showModalDialog('${pageContext.request.contextPath}/datastatistics/runingInfo_OneMinuteReportData.do?method=select&data='+data, window, 'dialogHeight:500px;dialogWidth:400px;help:no;status:no');	
          }
      
          else{
          window.open('${pageContext.request.contextPath}/datastatistics/runingInfo_OneMinuteReportData.do?method=select&data='+data,'','width=400,height=500,status=no,modal=yes');
          }	
          //window.showModalDialog('${pageContext.request.contextPath}/datastatistics/runingInfo_OneMinuteReportData.do?method=select&data='+data, window, 'dialogHeight:500px;dialogWidth:400px;help:no;status:no');	
  ...
  <body>
       <html:form action="runingInfo_OneMinuteReportData" method="post">
			...
			<tr>
			  ...
			  <tr>			     
				...
				<ec:table 
					...
					items="resulttu"
					var="bean"
					action="${pageContext.request.contextPath}/datastatistics/runingInfo_OneMinuteReportData.do?method=show"
					retrieveRowsCallback="limit"
					sortRowsCallback="process"
					filterRowsCallback="process"
					csvFileName="runingInfo_OneMinuteReportData.csv"
                                                  showTitle="ture"
					listWidth ="100%"
					listHeight="100%"
					width="100%"

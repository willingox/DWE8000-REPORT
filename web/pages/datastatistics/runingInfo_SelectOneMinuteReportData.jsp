...
<script type="text/javascript">
 ...
 //window.dialogArguments.window.navigate('${pageContext.request.contextPath}/datastatistics/runingInfoData.do?');
	 ...
	 if (window.showModalDialog!=null)//IE判断
           {
      window.dialogArguments.runingInfo_OneMinuteReportDataForm.action = '${pageContext.request.contextPath}/datastatistics/runingInfo_OneMinuteReportData.do?check_val='+check_val;
		
		window.dialogArguments.runingInfo_OneMinuteReportDataForm.submit();
		window.close();
          }
		 ...
		 window.opener.runingInfo_OneMinuteReportDataForm.submit();
		top.close();

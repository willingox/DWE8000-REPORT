...
<script type="text/javascript">
	...
	var nowId = ${runingInfo_SelectTenMinuteDataForm.id};
						...
						$("#SelectWind")
								.change(
										function() {
											...
											var newId = document.runingInfo_SelectTenMinuteDataForm.id.value;
											//alert("--"+nowId+"--"+newId);
...
/* 		var obj = document.getElementById("select2").options;
		...
		var str1=str.replace(reg,"'");
           ...
           {
        window.dialogArguments.runingInfo_TenMinuteDataForm.check_val.value =str1;
		window.dialogArguments.runingInfo_TenMinuteDataForm.submit();
		window.close();
          }
      
          else{
          window.opener.runingInfo_TenMinuteDataForm.check_val.value =str1;
		window.opener.runingInfo_TenMinuteDataForm.submit();
		top.close();
          }
...
<BODY scroll="auto"
	...
	<html:form action="runingInfo_SelectTenMinuteData" method="post">
					...
					<TABLE>
						...
						<TR>
							...
							<TD id="SelectWind"><html:select property="id"
									value="${runingInfo_SelectTenMinuteDataForm.id}"

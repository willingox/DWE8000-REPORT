...
public class RuningInfo_TenMinuteDataAction extends DispatchAction{


	private static final Log log = LogFactory.getLog(RuningInfo_TenMinuteDataAction.class);
	IRuningInfo_TenMinuteService runingInfo_TenMinuteService; 
	...
	public void setServlet(ActionServlet servlet) {
		...
		runingInfo_TenMinuteService = (IRuningInfo_TenMinuteService) wac.getBean("runingInfo_TenMinuteService");																														
	...
	public ActionForward show(ActionMapping mapping, ActionForm form,
		...
		// ��ѯ���
		RuningInfo_TenMinuteDataForm dataForm = (RuningInfo_TenMinuteDataForm) form;
			...
			String check_val = request.getParameter("check_val");
			 ...
			 Date startDate = YearFormatUtil.get().parse(dataForm.getStartDateDisp());
				...
				if(startYear.compareTo(endYear)==0){
			     resulttu = runingInfo_TenMinuteService.list(dataForm.getStartDateDisp(),dataForm.getEndDateDisp(),check_id,check_value,dataForm.getFlag(),1);
				}
				if(startYear.compareTo(endYear)!=0){
					resulttu = runingInfo_TenMinuteService.list(dataForm.getStartDateDisp(),startYear+"-12-31 23:59:59",check_id,check_value,dataForm.getFlag(),1);
					resulttu1 = runingInfo_TenMinuteService.list(endYear+"-01-01 00:00:00",dataForm.getEndDateDisp(),check_id,check_value,dataForm.getFlag(),2);

			...
			<tr>
				...
				<ec:table 
					...
					<ec:row highlightRow="true">
						...
						<ec:column alias="menuName" title="菜单名称" filterable="false" styleClass="ecTableBody" headerClass="ecTableHead" style="width:20%;">
							<a href="javascript:edit('${bean.menuId}')">${bean.menuName}</a>
						</ec:column>
						<ec:column property="xtMenu.menuName" title="上级菜单" filterable="false" styleClass="ecTableBody" headerClass="ecTableHead" style="width:20%;" />
						<ec:column property="xtResource.resName" title="对应资源" filterable="false" styleClass="ecTableBody" headerClass="ecTableHead" style="width:30%;" />
						
						<ec:column property="menuOrder" title="排序号" filterable="false" styleClass="ecTableBody" headerClass="ecTableHead" style="width:10%;" />
						<ec:column alias="menuActive" title="有效" viewsAllowed="html,compact" sortable="false" styleClass="ecTableBody" headerClass="ecTableHead" style="width:5%;">

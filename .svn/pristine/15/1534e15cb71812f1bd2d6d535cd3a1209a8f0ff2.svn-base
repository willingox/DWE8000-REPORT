		...
		<TD>
			...
			<TABLE cellSpacing="0" cellPadding="0" height="100%" width="100%" border="0">
				<TR>
					...
					<!-- 内容区左侧树结束-->
					<!-- 内容区右侧主页面开始-->
					<!--liux火狐浏览器     <TD vAlign=top align="center" height="100%" width="100%" > --><TD vAlign=top align="center" height="100%" width="100%" >
					<!-- Windows ie11浏览器   <TD vAlign=top align="center" height="100%" > --> 
